...
В разделе "Купить полис" первым делом объясняется, каким образом происходит покупка полиса в онлайновом режиме. Основные этапы покупки: 

Клиент выбирает вид страхования и заполняет Web-форму для определения стоимости этого страхования. Если клиент согласен с суммой, тогда он переходит к следующему этапу. 
...
Получение полиса. Если клиент проживает в Москве или Санкт-Петербурге, доставка полиса происходит курьерской службой компании. В противном случае, полис будет доставлен клиенту по почте срочным заказным письмом. 
На данный момент "Группа Ренессанс" предлагает восемь видов онлайнового страхования. Наиболее популярными являются (в порядке убывания): страхование автогражданской ответственности, медицинское страхование выезжающих за рубеж, страхование от несчастного случая и страхование имущества (квартир и дач). К сожалению, в онлайновом режиме на Web-сайте компании нельзя узнать сумму страховки по страхованию автомобилей, не говоря уже об оформлении покупки данного вида полиса. Возможно только заполнение Web-формы, где клиент описывает основные характеристики своей машины, а затем по оставленной контактной информации персонал страховой группы связывается с клиентом и сообщает ему сумму страховки.

Самой последней страховой онлайновой услугой, которую предложила компания, является возможность приобретения индивидуального полиса добровольного медицинского страхования (ДМС) без прохождения медосмотра и заполнения медицинских анкет. Многие аналитики посчитали такой шаг весьма рискованным и грозящим компании серьезными убытками. 

Интернет-программа ДМС "Ренессанс Страхования" включает в себя полное амбулаторно-поликлиническое обслуживание, а именно: вызов врача на дом, оказание стоматологической помощи, выдачу бюллетеней и медицинских справок, выписку медикаментов, диагностические исследования, лечебные процедуры, медицинскую помощь на дому. Программа предполагает возрастные ограничения: ею могут воспользоваться люди с 15 до 60 лет. Расценки на годовое обслуживание колеблются от $227 до $440 в зависимости от выбранного медучреждения. Компания предлагает шесть поликлиник, в том числе Минэкономики, МИДа, Финансовой академии при правительстве РФ.

При наступлении любого страхового случая, клиент в виртуальном офисе может заполнить заявление на возмещение, распечатать его и, подписав, привезти в обычный офис компании.


"Российское страховое народное общество" - РОСНО (http://www.rosno.ru/)

Страховая компания РОСНО работает на рынке страховых услуг уже 8 лет. Сегодня РОСНО является крупнейшей российской универсальной страховой компанией, имеющей лицензии на право осуществления всех классов добровольного и обязательного страхования. Компания располагает 74 филиалами в 64 регионах России. Клиентами РОСНО являются более 3000 предприятий и организаций и свыше 6 млн. человек. Компания обладает одним из лучших Web-сайтов по страхованию. В данном виртуальном офисе клиент может не только подробно ознакомиться с общей информацией о компании, узнать о предлагаемых ею услугах, изучить финансовую отчетность, а с недавнего времени и купить полис, но и заполнить анкету кандидата по требуемой вакансии в компании РОСНО.
...
Виртуальный офис Промышленно-Страховой Компании (ПСК) условно состоит из двух частей. Первая - информационная. Здесь клиент может узнать общую информацию о компании, адреса центров продаж, агентств и филиалов, изучить финансовые показатели деятельности компании: динамику доли ПСК на рынке добровольного страхования и места ПСК в рейтинге российских страховых компаний, темпы роста сборов страховой премии и страховых выплат. В данной части сайта клиент так же может ознакомиться с подробным описанием всех страховых продуктов компании. Существует специальный раздел для новостей компании, конференция для обсуждения вопросов, связанных со страхованием.

Вторая часть сайта компании - "Страховой магазин". Здесь можно выбрать интересующий страховой полис, самостоятельно рассчитать его стоимость, заполнить заявление на страхование, оформить оплату и доставку полиса. 

В своем интернет-магазине ПСК предлагает потенциальным клиентам всю "Палитру страховых красок": страхование имущества, страхование транспортных средств и гражданской ответственности автовладельцев, страхование выезжающих за рубеж, страхование от несчастных случаев, смешанное страхование жизни и страхование от несчастных случаев детей, страхование дополнительной пенсии, долгосрочное накопительное страхование жизни и от несчастных случаев. 

В разделе "Квартира" ПСК предлагает клиенту полис "Вы и Ваша квартира". По этому полису клиент может застраховать саму квартиру, ее внутреннюю отделку, имущество от различного рода аварий (водопроводных, канализационных, отопительных систем и т.п.), кражи, стихийных бедствий. 

В разделе "Гараж, машина" клиент может самостоятельно рассчитать сумму страховой премии по любому из трех предлагаемых видов страхования: полное/частичное КАСКО, гражданская ответственность автовладельца и гражданская ответственность по полису "Универсал" (страхование ГО без привязки к автомобилю). При расчете полиса и последующем заполнении заявления на страхование клиент вводит все параметры, необходимые для составления договора, в том числе, влияющие на величину страховой премии. 

Полис страхования граждан, выезжающих за рубеж, гарантирует клиенту ПСК своевременное получение при возникновении такой необходимости медицинской, юридической и административной помощи. Причем, в Интернет-магазине можно выбрать сервисную компанию, услугами которой хотел бы воспользоваться клиент.

В разделах "Здоровье" и "Семья и дети" представлены полисы страхования от несчастных случаев для взрослых и детей. Клиент сам может выбрать страховую сумму и срок страхования и, уже исходя из этих и некоторых других данных, рассчитать стоимость полиса. 

В программе "Жизнь" клиент может рассчитать для себя или своих близких стоимость пенсионного купона, который гарантирует получение дополнительной пожизненной пенсии по достижении определенного возраста.

Полис "Гарант Плюс" сочетает накопление и смешанное страхование жизни и от несчастных случаев. Страхование производится в валютном эквиваленте. В интернет-магазине клиент может выбрать любой из вариантов полиса, которые различаются величиной страховой суммы и, соответственно, размером страховой премии.

Все эти полисы можно не только заказать в "Страховом магазине", но и оплатить любым удобным способом: кредитной или расчетной картой, наличными представителю ПСК, наличный или безналичный расчет через отделения Сбербанка и Автобанка. Способ доставки полиса: курьером по Москве, по почте, получение в одном из московских Центров продаж.


ОСАО "Ингосстрах" (http://www.ingos.ru/)

В Интернет-офисе одной из самых крупных компаний России ОСАО "Ингосстрах" клиент может ознакомиться со всеми сторонами деятельности фирмы, запросить интересующую его информацию по спектру предлагаемых услуг и любому из видов страхования, а также подать заявление в онлайновом режиме на приобретение полиса. В офисе организовано несколько бизнес-площадок: Интернет-представительство (www.ingos.ru/company), Интернет-агентство (http://agency.ingos.ru/), Бизнес-бюро (http://b2b.ingos.ru/). 

В Интернет-представительстве приведены общие сведения о компании, продуктах и услугах для физических и юридических лиц, сведения о региональных и зарубежных сетях компании, контактные адреса, телефоны, электронная почта, а также последние новости. Надо отдать должное представленной в этом разделе финансовой отчетности. Клиент может ознакомиться с общими итогами развития компании за период с 1997 по 1999 год, балансовыми данными, отчетом о прибылях и убытках, бухгалтерским балансом, пояснительной запиской к бухгалтерскому отчету (эти данные представлены за последний отчетный период). В бизнес-бюро подробно описаны услуги для юридических лиц. В Бюро можно подобрать необходимую страховую защиту, получить консультации в области корпоративного страхования и перестрахования. 

В Интернет-агентстве клиенту предлагается ознакомиться с тремя продуктами компании для физических лиц, рассчитать их стоимость, подать заявление на покупку страхового полиса в электронном виде. Здесь же покупатель может узнать, кто обслуживает агентство. Это всего четыре человека - руководитель агентства, менеджер по страхованию средств транспорта, менеджер по страхованию путешественников и Web-мастер. Для общения с посетителями агентства организованы Книга жалоб и предложений, Web-форум, конференция. В разделе сайта "Информация для клиентов" можно просмотреть список своих полисов, узнать, как действовать в ситуациях, связанных со страховыми случаями, получить бланк "Извещения о страховом случае". При необходимости это извещение должно быть доставлено в офис компании лично, по почте или по факсу.

Подать заявление на страхование в Интернет-агенстве компании Ингосстрах можно в разделе "Страховые продукты". Здесь покупатель выбирает вид страхования - Ингос-Тур, Ингос-Авто (страхование ГО), Ингос-комби (страхование ТС). Покупатель может ознакомиться с подробным описанием продуктов, с правилами страхования, различными программами страхования. Для того чтобы подать заявление, клиент должен зарегистрироваться, после чего он получает имя и пароль пользователя. При выборе страхования Ингос-комби клиент не может рассчитать сумму премии, ему предлагается заполнить соответствующую Web-форму. Эта анкета попадет к менеджеру агентства по страхованию автотранспорта, который подготовит и направит в адрес клиента предложение на страхование. При выборе двух других видов страхования клиент может рассчитать стоимость полиса и подать заявление на страхование. Заявление будет действительно в течение семи рабочих дней. За этот период клиенту следует обратиться в один из московских офисов компании и, назвав номер своего заявления или фамилию, получить счет на оплату. Оплата счета производится наличными или по кредитной карте в кассе офиса. После оплаты покупателю вручается полис. 


ОАО Ресо-Гарантия (http://www.reso.ru/)

Виртуальный офис компании Ресо-Гарантия был основан в июне 2000 года. За три с половиной месяца работы было продано 210 полисов, из них автомобильное страхование - 185, страхование имущества - 21 (квартиры и дачи), страхование от несчастного случая - 3, медицинское страхование - 2.

В своем офисе компания предлагает проводить несколько начальных этапов сделки. Заключительный этап, когда клиент получает полис, а вместе с полисом необходимые комментарии и более детальные объяснения правил страхования, проходит с помощью агентов. Таким образом, сначала клиент заходит на Web-сайт компании, где размещены анкеты по всем видам страхования, заполнив которые, он может получить предварительную котировку. Там же представлены правила страхования. 
...
Обычно, на персональных Web-сайтах компании или на мини-порталах посетителю рекомендуется пройти регистрацию, то есть заполнить анкету с личными данными и, если на сайте предлагается один вид услуг, данными, которые могут быть использованы при подаче заявки на страхование.
...
Компания  Интернет-представительство 
American International Group http://www.aigdirect.com/ 
Esurance http://www.esurance.com/ 
Electric Insurance Company http://www.electricinsurance.com/ 
eCovarage http://www.ecoverage.com/ 
Aflac  http://www.aflac.com/ 
RelianceDirect Insurance Company  http://www.reliancedirect.com/ 
Allstate  http://www.allstate.com/ 
Instant Auto Insurance http://www.instantauto.com/ 
Unum  http://www.unumdirect.com/ 


"American International Group, Inc." (http://www.aig.com/)
...
Web-cайт компании содержит четыре основных раздела. Первый описывает общую информацию о компании. Здесь представлены данные о структуре компании, ее подразделениях, составе совета директоров. Посетитель может ознакомиться со статьями из прессы, которые посвящены компании. К сожалению, на сайте отсутствует информация о финансовых показателях деятельности EIC. Зато существует подраздел, в котором описываются основные корпоративные ценности.

Другой раздел Web-сайта содержит информацию о страховых продуктах компании. Здесь также представлены словарь со страховыми терминами и ответы на часто задаваемые вопросы. В третьем разделе содержатся различные советы, статистика по страхованию и объектам страхования: причины снижения страховой премии, статистика по угону машин в зависимости от марки и пр. 

Последний раздел, четвертый, предназначен для клиентов компании. Введя свой логин и пароль, клиент может просмотреть состояние своего полиса и информацию, связанную с оплатой полиса. Здесь же клиент может оплатить страховую премию с помощью пластиковой карты прямо через Интернет. При наступлении страхового случая клиенту следует также воспользоваться этим разделом.

Существуют также вспомогательные разделы: Web-тур, в котором по шагам разобран процесс онлайновой покупки; раздел обратной связи; подраздел, посвященный приватности информации, интеллектуальной собственности и пр.

Сам процесс Интернет-покупки начинается с главной страницы Web-сайта - клиенту нужно выбрать его штат и интересующий вид страховки. Если клиент хочет застраховать имущество, то ему предстоит заполнить всего одну анкету - заказ на страхование, после чего сотрудники компании свяжутся с ним для дальнейших действий. Онлайновая покупка полиса по автострахованию состоит из пяти этапов, на каждом из которых покупателю нужно заполнить несколько анкет (их общее количество варьируется в зависимости от программы страхования, в среднем около 12). С помощью специального индикатора, покупатель может контролировать, на каком этапе покупки он находится.
