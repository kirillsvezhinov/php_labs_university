...
Онлайновые аукционы - как это делается
...
Как работают онлайновые аукционы

Устройство работы виртуальных аукционов мало чем отличается от обычных.

В торгах участвую две стороны - продавец и покупатель (покупатели). Организаторы аукциона чаще всего взимают определенную плату за выставление товара на торги. 
...
Онлайновый аукцион представляет собой информационную базу, в которой содержатся описания товаров, допущенных к торгам (лотов). Обычно общий список лотов разбит на тематические подкатегории (например, автомобили, компьютерные комплектующие, книги и т.п.), облегчающие поиск необходимого товара.
...
Покупателю, победившему в аукционном торге, сообщается об этом по электронной почте или по телефону, при этом он получает данные о том, как он может оплатить и получить купленный товар.

Продавец, в свою очередь, получает сообщение, в котором ему говорится, как он может связаться с пользователем, купившим его лот.
...
Название Продаваемые товары Особенности 

Sothebys.com Произведения искусства и антиквариат В описание лота входит эспертная оценка. Платеж только картами Visa, MasterCard и American Express. 
AuctionVine Вина Платеж - чеком, денежным переводом или наличными. Рейтинги. 
eBay Все Рейтинги. Очень обширный список лотов. Платеж - картами, чеками или переводом. 
Sothebys.Amazon.com Все Рейтинги. Отзывы об оппонентах. 
FirstAuction Все Платеж только при помощи кредитных карт. 
Yahoo!Auctions Все Платеж - кредитной картой, переводом, чеком, электронной почтой (открыть счет в системе). Рейтинги и отзывы. 
DigiBid.com Аудио и видео продукция Платеж только при помощи кредитных карт. 
...
Molotok.ru Все Рейтинги и отзывы. Возможна продажа по фиксированной цене ("М-Лоток"). 
OHO.ru Все Возможна продажа по фиксированной цене. 
Azbooka.com Все Платеж - чеком, наличными переводом (по выбору продавца). 
TradeZone Все Позволяет покупателям разместить объявление об интересующем товаре. 
Stavka.ru Все   
http://itrade-colibri.infoart.ru/ Книги Все лоты - из магазина "Co@Libri" 
auctions.ru Все Аукционы проходят в течение часа (30-120 мин.) 
Auction.ru Все Рейтинги продавцов ("VIP - Продавцы"). Используется голландская и английская схема проведения аукциона. 
c99.ru Все Бесплатный аукцион. Используется английская схема проведения. 
